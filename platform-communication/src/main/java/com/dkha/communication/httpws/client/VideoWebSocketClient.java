...
public class VideoWebSocketClient {
    ...
    public void open(String wappIdType) throws Exception {
        ...
        channel.closeFuture().addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture channelFuture) throws Exception {
                logger.info("[{} Video WebSocket Client close complete]", channel.toString());
                group.shutdownGracefully();
                open(WappIdCache.WappIdTypeEnum.VIDEO.code);
            }
        });
    ...
    public void sendMessage(String message) {
        logger.info("[Video 客户端发送消息-->{}]", message);
